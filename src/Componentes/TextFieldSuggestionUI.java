...
public class TextFieldSuggestionUI extends MetalTextFieldUI {
    ...
    public TextFieldSuggestionUI(final JTextField textfield) {
        ...
        textfield.setSelectionColor(new Color(57, 105, 138));
        textfield.addFocusListener(new FocusAdapter() {
            @Override
            public void focusGained(FocusEvent fe) {
                border.setColor(new Color(0, 112, 192));  // color de seleccion de texto en la caja de texto
                textfield.repaint();
            }
...
//        AutoCompleteDecorator.decorate(textfield, items, false);
    ...
    private class Border extends EmptyBorder {
        ...
        private Color focusColor = new Color(0, 112, 192);
